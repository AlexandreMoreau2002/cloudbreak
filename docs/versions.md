...
> Dernière mise à jour : 2026-08-31 (migration domaine `cloudbreak-app.com` commitée sur les 3 submodules).
...
| Ops | `ops/` | `develop` | `39d2caf` (2026-08-31) | ✅ auto-deploy `develop` → https://dev-ops.cloudbreak-app.com | Next.js `16.2.10`, React `19.2.4`, TypeScript `^5` |
